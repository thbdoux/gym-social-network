// components/workouts/InstanceExerciseManager.tsx
...
type InstanceExerciseManagerProps = {
  visible: boolean;
  programId: number;
  workoutId: number;
  exercises: any[];
...
const InstanceExerciseManager = ({
  ...
  // API hooks
  const { mutateAsync: updateWorkout, isLoading: isUpdating } = useUpdateProgramWorkout();
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      // Save all exercises in one update
      await updateWorkout({
        programId,
        workoutId,
        updates: {
...
export default InstanceExerciseManager;