...
const LoginPage = () => {
  ...
  useEffect(() => {
    ...
    console.log("Token in localStorage on Login page:", token ? "Present" : "Not found");
    
    // Add immediate check if we're already authenticated
    if (isAuthenticated) {
  ...
  // If already authenticated, redirect to feed immediately
  if (isAuthenticated) {
    console.log("Rendering redirect to /feed");
