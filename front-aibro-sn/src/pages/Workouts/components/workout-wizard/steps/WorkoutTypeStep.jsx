...
import { Calendar, Dumbbell, Zap, Heart, Edit, Check, ChevronRight, Bookmark } from 'lucide-react';
...
const WORKOUT_TYPES = [
  { 
    ...
    hoverEffect: "scale-105 rotate-3",
  },
  { 
    name: "Lower Body", 
    icon: <Dumbbell className="w-5 h-5" />,
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        {(programs?.length > 0) && (
          <div>
            ...
            <div className="relative overflow-hidden group rounded-lg">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none z-10">
                <Bookmark className="h-5 w-5 text-gray-400 group-hover:text-white transition-colors duration-300" />
              </div>
              ...
              {programsLoading ? (
                <div className="w-full bg-gray-800 border border-gray-700 group-hover:border-gray-500 rounded-lg pl-10 pr-4 py-3 text-gray-400 relative z-0">
                ...
                <div className="w-full bg-gray-800 border border-red-700 rounded-lg pl-10 pr-4 py-3 text-red-400 relative z-0">
                ...
                <select
                  ...
                  className="w-full bg-gray-800 border border-gray-700 rounded-lg pl-10 pr-4 py-3 text-white relative z-0
                    transition-all duration-300 focus:ring-2 focus:ring-offset-1 focus:ring-offset-gray-900 focus:ring-green-500 focus:border-transparent outline-none
                    appearance-none cursor-pointer group-hover:border-gray-500"
                >
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                <ChevronRight className="h-4 w-4 text-gray-400 transform rotate-90 group-hover:text-white transition-colors duration-300" />
              </div>
            </div>
          </div>
        )}
