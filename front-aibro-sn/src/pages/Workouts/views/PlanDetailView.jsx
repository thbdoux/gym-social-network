...
//                 onDuplicate={canEdit ? () => handleDuplicateWorkout(selectedPlan.id, workout.instance_id) : undefined}
//                 inProgram={true}
//                 onDayChange={canEdit ? (newDay) => handleDayChange(selectedPlan.id, workout.instance_id, newDay) : undefined}
//                 onClick={() => setSelectedWorkout(workout)}
//               />
//             ))}
//           </div>

//           {/* Add Workout Button - Fixed positioning with proper spacing */}
//           {canEdit && (
