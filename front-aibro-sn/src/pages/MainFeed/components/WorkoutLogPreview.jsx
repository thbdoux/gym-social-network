...
import { Dumbbell, Calendar, Clock, Target, ChevronDown, ChevronUp, ClipboardList, MapPin } from 'lucide-react';
import api from '../../../api';
...
const WorkoutLogPreview = ({ workoutLogId, workoutLog: initialWorkoutLog, canEdit }) => {
    ...
    return (
      <>
        <div 
          className="mt-4 bg-gray-800/50 rounded-xl overflow-hidden border border-gray-700/50 cursor-pointer"
